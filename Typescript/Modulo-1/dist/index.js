...
console.log(`Datos sin atípicos (límite=2): [${datosFiltrados ? datosFiltrados.join(", ") : "null"}]`);
...
console.log(`Filtrar atípicos [${arrayUnElemento}]: [${filtrarAtipicos(arrayUnElemento) || "null"}]`);
